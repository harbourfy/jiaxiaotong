...
import com.app.jiaxiaotong.activity.AlertDialog;
import com.app.jiaxiaotong.activity.BaiduMapActivity;
import com.app.jiaxiaotong.activity.ChatActivity;
import com.app.jiaxiaotong.activity.ContextMenu;
import com.app.jiaxiaotong.activity.ShowBigImage;
import com.app.jiaxiaotong.activity.ShowNormalFileActivity;
import com.app.jiaxiaotong.activity.ShowVideoActivity;
import com.app.jiaxiaotong.activity.UserProfileActivity;
import com.app.jiaxiaotong.im.MyHXSDKHelper;
import com.app.jiaxiaotong.im.controller.HXSDKHelper;
import com.app.jiaxiaotong.im.task.LoadImageTask;
import com.app.jiaxiaotong.im.task.LoadVideoImageTask;
import com.app.jiaxiaotong.im.utils.DateUtils;
import com.app.jiaxiaotong.im.utils.ImageCache;
import com.app.jiaxiaotong.im.utils.ImageUtils;
import com.app.jiaxiaotong.im.utils.SmileUtils;
...
public class MessageAdapter extends BaseAdapter{
	...
	public int getItemViewType(int position) {
		...
		if (message.getType() == Type.TXT) {
			...
			else if(((MyHXSDKHelper) HXSDKHelper.getInstance()).isRobotMenuMessage(message))
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		if(message.direct == Direct.SEND){
			UserUtils.setCurrentUserNick(holder.tv_usernick, UserInfoKeeper.readUserInfo(activity).getName());
		}
